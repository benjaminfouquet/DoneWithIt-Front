...
```
cd existing_repo
git remote add origin https://gitlab-student.centralesupelec.fr/2018fouquetb/donewithit.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-student.centralesupelec.fr/2018fouquetb/donewithit/-/settings/integrations)
